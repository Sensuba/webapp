...
export default class Hero extends Component {
  ...
  render () {
    ...
    return (
      <div className="game-hero game-card-targetable" card-type={this.props.src.id.type} card-no={this.props.src.id.no} onClick={e => this.props.onSelect(e, this.props.src, this.props.src.level)}>
