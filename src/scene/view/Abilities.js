    ...
    return (
      ...
      { lv > 1 ?
        <div className={"game-ability" + (usable[0] ? "" : " game-ability-locked")} draggable="true"
          ...
          onClick={e => this.props.onSelect(e, list[lv === 3 ? 2 : 0], this.props.hero)}>
          <Ability colors={this.props.hero.colors} src={list[lv === 3 ? 2 : 0]}/>
        </div> : "" }
      { lv === 3 ? <div className="game-ability game-ability-aura" onClick={e => this.props.onSelect(e, list[4], this.props.hero)}><Ability colors={this.props.hero.colors} src={list[4]}/></div> : "" }
      { this.props.levelup && lv !== 3 ? 
        <div className={"game-ability" + (usable[1] ? "" : " game-ability-locked")} draggable="true"
          ...
          onClick={e => this.props.onSelect(e, this.props.hero, this.props.hero.level+1, this.props.hero)}>
      ...
      { lv > 1 ?
        <div
          ...
          onClick={e => this.props.onSelect(e, list[lv === 3 ? 3 : 1], this.props.hero)}>
